...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Loan Number:">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">EMI amount:</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="EMI amount:">
  </div>
