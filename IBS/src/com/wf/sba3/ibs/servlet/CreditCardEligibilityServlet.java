...
public class CreditCardEligibilityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       private CreditcardDao CreditcardeligibilityDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreditCardEligibilityServlet() {
        super();
    ...
    public void init(ServletConfig config) throws ServletException {
    	...
    	this.CreditcardeligibilityDao= new CreditcardDao(driver, url, username, password);
    	try {
    		CreditcardeligibilityDao.connect();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		try {
			this.CreditcardeligibilityDao.InsertCCEligibilityDetails(C);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
