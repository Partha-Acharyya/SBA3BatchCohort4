...
<spring:form action="AddIBSBeneficiary" method="post" modelAttribute="Beneficiary">

		<table style="width: 80% , height:80%">
			
			<tr>
				<td><H4>Add a Beneficiary</H4></td>
			</tr>
			<tr>
...
<spring:form action="AddIBSBeneficiary" method="post" modelAttribute="Beneficiary">
		...
		<table style="width: 80% , height:80%">
			...
			<tr>
				<td><spring:label path="BeneficiaryAccountType">Modify a Beneficiary</spring:label></td>
...
<spring:form action="AddIBSBeneficiary" method="post" modelAttribute="Beneficiary">
		...
		<table style="width: 80% , height:80%">
			...
			<tr>
				<td><spring:label path="BeneficiaryAccountType">Delete a IBS Beneficiary</spring:label></td>
				<td><spring:select path="BeneficiaryAccountType" name="Accounts">
						<spring:option value="Savings" label="Savings" />
						<spring:option value="Credit Card" label="Credit Card" />
				</spring:select></td> 
